...
export default function InquireModal({ product, isOpen, onClose }) {
  ...
  return (
    <>
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 transition-opacity duration-300 opacity-100"
        onClick={onClose}
      />
      {/* Dialog container */}
      <div
            ...
            {isSuccess ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-orange-700 text-white font-bold py-3.5 rounded-lg hover:bg-orange-800 transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-h-[48px]"
                >
                  {isSubmitting ? (
